...
# Disable automatic capitalization, smart dashes, smart quotes, auto-correct and period substitution
# as it’s annoying when typing code
...
# Screenshot location, format and shadow
...
# Add my own profile
defaults write com.apple.Terminal "Window Settings" -dict-add "mk" "$(plutil -convert xml1 -o - macos/terminal/mk.terminal)"
defaults write com.apple.Terminal "Default Window Settings" -string "mk"
defaults write com.apple.Terminal "Startup Window Settings" -string "mk"
