...
export ANTHROPIC_BASE_URL=http://localhost:11500 ANTHROPIC_AUTH_TOKEN=dummy ANTHROPIC_MODEL=claude-opus-5 ANTHROPIC_DEFAULT_SONNET_MODEL=claude-sonnet-5 ANTHROPIC_SMALL_FAST_MODEL=claude-haiku-4.5 ANTHROPIC_DEFAULT_HAIKU_MODEL=claude-haiku-4.5 DISABLE_NON_ESSENTIAL_MODEL_CALLS=1 CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC=1 && claude
